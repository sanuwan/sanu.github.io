                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span9">
                                        <form action="../controllers/mail.php" method="POST" enctype="multipart/form-data">  
                                            ...
                                            <input type="hidden" name="cid" value="<?php echo $STbA['id']; ?>">
                                            <input type="hidden" name="filename" value="<?php echo $fname ?>">

                                            <label for="inputUsername"> Vacancy Ref No</label>
                                            <input type="text"  class="span10" value="<?php echo $STbA['reference_number']; ?>" name="ref" readonly="readonly"/>
                                            <div class="separator"></div>
                                            <label for="inputUsername">Email Subject</label>
                                            <input type="text" class="span10" value="Application For Vacancy : <?php echo $STbA['job_title']; ?>" name="subject" required readonly="readonly"  />
                                            <div class="separator"></div>
                                            <label for="inputUsername">Your Name</label>
                                            <input type="text" class="span10" value="" name="uname" required/>
                                            <div class="separator"></div>
                                            <label for="inputUsername">Your Email</label>
                                            <input type="email" class="span10" value="" name="uemail" required/>
                                            <div class="separator"></div>               

                                            <div class="form-actions" style="margin: 0; padding-right: 0;">
                                                <button type="submit" class="btn btn-icon btn-primary glyphicons circle_ok pull-right"><i></i>Apply</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>                            
