            ...
            <section style="margin-top: 25px;">
                    ...
                    <div class="widget widget-2">
                        ...
                        <div class="widget-body" style="padding-bottom: 0;">
                            <div class="row-fluid">
                                <div class="span3">
                                    <strong>Insert Your Details</strong>
                                </div>
                                <div class="span9">
                                    <form action="controllers/contact_mail.php" method="POST">
                                        <label for="inputUsername">Name</label>
                                        <input type="text" name="name" id="inputUsername" class="span10" required="">
                                        <div class="separator"></div>
                                        <label for="inputUsername">Your Email</label>
                                        <input type="email" name="uemail" id="inputUsername" class="span10" required="">
                                        <div class="separator"></div>
                                        <label for="inputUsername">Subject</label>
                                        <input type="text" name="subject" id="inputUsername" class="span10" required="">
                                        <div class="separator"></div>
                                        <label for="inputUsername"> Massage</label>
                                        <textarea name="msg" class="span10" required=""> </textarea>
                                        <div class="separator"></div>
                                    </div>
                            </div>
                            <div class="row-fluid">
                                <div class="form-actions" style="margin: 0; padding-right: 0;">
                                    <button type="submit" class="btn btn-icon btn-primary glyphicons circle_ok pull-right"><i></i>Send</button>
                                    </form>
                                </div>
                            </div>
                        </div>
